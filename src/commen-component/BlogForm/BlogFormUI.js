...
import { Controller, FormProvider, useFormContext ,methods} from "react-hook-form";

const BlogFormBase = ({ onSubmit }) => {
        ...
        {/* <FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)}> */}
                        ...
                        <Grid item xs={12} md={6}>
                          <Stack direction="row" spacing={1}>
                            ...
                            <IconButton
                              onClick={addTag}
                              disabled={
                                !currentTag.trim() || watchedTags.length >= 10
                              }
                              sx={{
            ...
            <Box mt={2}>
              <Card
                sx={{
                  width: { xs: "100%", md: "100%", lg: "25%", xl: "25%" },
                  borderRadius: 3,
                  overflow: "hidden",
                }}
              >
